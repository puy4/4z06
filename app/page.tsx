      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`${lusitana.className}text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Welcome to Duodecimal Cribbage.</strong> This is the example for the {/*{' '}
            <a href="https://nextjs.org/learn/" className="text-blue-500">
              Next.js Learn Course
            </a>*/}
          duodecimal cribbage game
            , brought to you by Group 16.
          </p>
          <Link
            href="/login"
          ...
          >
            <span>Log in(unavailable)</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
          <Link
            href="/dashboard"
            ...
            className="flex items-center gap-5 self-start rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400  md:text-base"
          >
            <span>Play without login</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
        </div>
